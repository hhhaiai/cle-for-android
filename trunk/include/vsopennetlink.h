...
MYLIBAPI VS_INT32 SRPAPI VSNetComm_LinkLayer_Send(VS_ULONG SocketIDOfClient,VS_INT32 Length,VS_INT8 *FrameBuf,VS_UINT8 FreeFrameBufOrNot);  //  发送数据，FrameBuf是帧结构
